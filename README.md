...
4. **Lessons Learned 驱动**：每个插件都承载具体踩坑的修复（见各插件注释与 [`CODING-RULES`](https://github.com/tramington/7-Aspects-for-skill-engineering/blob/main/CODING-RULES.md)）

## 安装

见 [docs/install.md](docs/install.md)（通用步骤：复制到 profile node_modules + patch 注册 + 重启）。

## License

[MIT](LICENSE) © 2026 Rammy Tang (tramington)
